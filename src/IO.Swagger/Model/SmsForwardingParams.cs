...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SmsForwardingParams :  IEquatable<SmsForwardingParams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SmsForwardingParams" /> class.
        /// </summary>
        ...
        public SmsForwardingParams(string Type = default(string), int? Extension = default(int?), int? Application = default(int?))
        {
            this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SmsForwardingParams);
        }

        /// <summary>
        /// Returns true if SmsForwardingParams instances are equal
        /// </summary>
        /// <param name="other">Instance of SmsForwardingParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SmsForwardingParams other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
