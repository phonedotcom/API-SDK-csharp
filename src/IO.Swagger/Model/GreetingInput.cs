...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GreetingInput :  IEquatable<GreetingInput>, IValidatableObject
    {
        /// <summary>
        ...
        public string EnableLeaveMessagePrompt { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GreetingInput);
        }

        /// <summary>
        /// Returns true if GreetingInput instances are equal
        /// </summary>
        /// <param name="other">Instance of GreetingInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GreetingInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
