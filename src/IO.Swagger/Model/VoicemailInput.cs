...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoicemailInput :  IEquatable<VoicemailInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoicemailInput" /> class.
        /// </summary>
        ...
        public VoicemailInput(string Enabled = default(string), string Password = default(string), GreetingInput Greeting = default(GreetingInput), string Attachments = default(string), Notification Notifications = default(Notification), string Transcription = default(string))
        {
        ...
        public GreetingInput Greeting { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VoicemailInput);
        }

        /// <summary>
        /// Returns true if VoicemailInput instances are equal
        /// </summary>
        /// <param name="other">Instance of VoicemailInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoicemailInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
